...
aspect Tracer {
	...
	pointcut codeInsideMyProject() : within((pt.iscte.dcti.instrumentation..* || pt.iscte.dcti.visual_tracer..* || untraceable.*..*) && !pt.iscte.dcti.instrumentation.examples..*) || cflow(execution(String *.toString()));
