 ...
 */
/**
 * Represents a read access to a field.
 * @author Carlos Correia
 * @author Rute Oliveira
 * @version 1.0
 * @created 06-Nov-2009 15:52:06
 */
public class FieldRead extends AbstractJoinPoint {

	public FieldRead(Instance instanceThis, Instance instanceTarget,
	...
	public Vector<AbstractJoinPoint> getChilds() {
		return new Vector<AbstractJoinPoint>(0);
	}
	...
	public String getImageName() {
		return ImageUtils.ImageName.FieldRead.name();
	}
