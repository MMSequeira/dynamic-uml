 ...
 */
public class StaticInitialization extends CompositeJoinPoint {

	public StaticInitialization(Instance instanceThis, Instance instanceTarget,
	...
	public String getImageName() {
		return ImageUtils.ImageName.StaticInitialization.name();
	}
}