 ...
 */
/**
 * Represents a write on a field. 
 * @author Carlos Correia
 * @author Rute Oliveira
 * @version 1.0
 * @created 06-Nov-2009 15:52:06
 */
public class FieldWrite extends AbstractJoinPoint {

	public FieldWrite(Instance instanceThis, Instance instanceTarget,
	...
	public String getImageName() {
		return ImageUtils.ImageName.FieldWrite.name();
	}
}