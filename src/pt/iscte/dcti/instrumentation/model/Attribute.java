 ...
 */
/**
 * Represents the sintatic structure of an attribute.
 * @author Carlos Correia
 * @author Rute Oliveira
 * @version 1.0
 * @created 06-Nov-2009 15:52:05
 */
public class Attribute extends SintaticStructure {
	

	public Attribute(String signature, String name, int modifiers)
	{
