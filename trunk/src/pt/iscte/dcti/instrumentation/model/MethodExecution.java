 ...
 */
public class MethodExecution extends CompositeJoinPoint {

	public MethodExecution(Instance instanceThis, Instance instanceTarget,
	...
	public String getImageName() {
		return ImageUtils.ImageName.MethodExecution.name();
	}
